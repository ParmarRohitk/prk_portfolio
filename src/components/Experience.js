      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
          <Details
            ...
            company="JBcodeapp"
            time="June 2023 - Pursuing"
            address="Surat, Gujarat, India"
            companyLink=""
            work="At JBcodeapp, I work as a Full Stack Developer, specializing in creating efficient and user-friendly web applications. My role involves developing and maintaining frontend and backend systems, integrating APIs, and collaborating with cross-functional teams to deliver high-quality solutions. This onsite experience has further honed my ability to meet client expectations while working in a fast-paced environment."
          />
